...
(module.exports = function(flow){
  ...
  {
    var isDefaultCulture = cultureName == DEFAULT_CULTURE;
  ...
  js_at.append(flow.l10n.module.ast, js_at.parse('(' + function(path){
    var pkg;
    ...
    var loadCulture = function(name){
      try { pkg = basis.require(path[name]); } catch(e){};
    };
    ...
    module.exports.setCulture(currentCulture);
  } + ')(' + JSON.stringify(path) + ')'));
