...
(module.exports = function(flow) {
    ...
    if (basisFile) {
        ...
        stat.body[0].declarations[0].init = resourceAst;
    ...
    for (var name in packages) {
        ...
        switch (pkg.layout) {
            case 'basis':
                ...
                packageFile = flow.files.add({
                    type: 'script',
                    outputContent: (isCoreFile ? formatList('resources', resourceToc) : '') +
            ...
            default:
                ...
                packageFile = flow.files.add({
                    type: 'script',
                    outputContent: formatList('filelist', pkg.map(function(file) {
