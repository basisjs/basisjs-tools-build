    ...
    else
    {
      ...
      else
      {
        if (flow.js.rootNSFile.basis)
        {
          // temp solution
          // TODO: make it better
          var body = flow.js.rootNSFile.basis.ast.body[1].expression.callee.body.body;
          var codeToInsert = at_js.parse(
            file.theme
          ...
          Array.prototype.splice.apply(body, [body.length - 1, 0].concat({ type: 'ExpressionStatement', expression: codeToInsert }));
        }
        else
        {
