...
(module.exports = function(flow){
  ...
  for (var i = 0, file; file = queue[i]; i++)
    if (file.type == 'template')
    {
      ...
      // generate functions
      var fn = flow.js.basis.template.htmlfgen.getFunctions(file.ast);
  ...
  var fgenBody = flow.tmpl.fgen.ast.body[0];

  utils.append(fgenBody, jsAt.parse(';tmplFunctions={' + fnMap.join(',') + '};'));
